...
def create_leaf_material(src_hue, glow=False):
    ...
    if glow:
        ...
        nt.links.new(loc_add_node.outputs[0], hsv_node.inputs.get("Red"))
        nt.links.new(sep_node.outputs[1], hsv_node.inputs.get("Green"))
        nt.links.new(sep_node.outputs[2], hsv_node.inputs.get("Blue"))
